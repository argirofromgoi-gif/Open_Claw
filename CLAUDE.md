...
- Το ίδιο όνομα χρώματος μπορεί να χρησιμοποιηθεί σε πολλά προϊόντα — η μοναδικότητα ισχύει μόνο μέσα στις variations ενός προϊόντος
- Format: `Όνομα` (π.χ. "Dusty Rose", "Oil Blue", "Sea Blue") — χωρίς αριθμούς εκτός αν το όνομα του προϊόντος τους περιέχει
