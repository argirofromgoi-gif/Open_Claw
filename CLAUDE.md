...
2. **Πρότεινε** — βάσισε το νέο όνομα στον αγγλικό κωδικό μέσα στο όνομα (π.χ. "DUSTY-ROSE" → "Dusty Rose")
...
- Format: `Όνομα` (π.χ. "Dusty Rose", "Oil Blue", "Sea Blue") — χωρίς αριθμούς εκτός αν χρειάζεται για μοναδικότητα μέσα στο batch
